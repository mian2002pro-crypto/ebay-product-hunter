...
const breakEven=estimateEconomics({sellPrice:50,supplierCost:20,shipping:5,feeRate:.13});
assert.equal(breakEven.profit,18.5);
assert.equal(Math.round(breakEven.margin*100),37);
